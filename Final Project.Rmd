...
plot(PC1scores,PC2scores, xlab = "PC 1 (52%)", ylab = "PC 2 (18%)", main="PCA of Macronutrients", type = "n")
gp <- data$group == "vegetable"
...
biplot(pca,xlabs=data$food.item[-c(6,15, 17, 20, 31, 35, 36, 41)], xlab = "PC1 (43%)", ylab = "PC2 (26%)")
# PC1scores <- pca$scores[,1]
# PC2scores <- pca$scores[,2]
