...
**Figure 2:** Density graphs for all quantitative variables. All variables are standardized with the exception of Vitamin A
```{r message=FALSE}
...
**Figure 3:** correlelogram of variables rounded to first decimal place. 
```{r correlelogram}
...
The highest correlation was 0.79 between total fat and saturated fat. This shouldn't surprise us, as total fat is composed of saturated and unsaturated fat. However, this point might be used to counter the argument of "not all fat is bad" that you sometimes hear people say.  While this point has merit (unsaturated fats are indeed good for you), it seems like total fat is a good indicator of the level of unhealthy fat. Generally speaking, fat is bad. "Not all fat is bad" likely only applies to unique foods that were excluded from this analysis. 
...
**Figure 17:** PCA of vitamins and minerals with outliers removed. 
